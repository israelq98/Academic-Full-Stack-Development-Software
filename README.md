...
Integrated [Mailtrap ](https://mailtrap.io/) as a third-party email API service to automate transactional email notifications, sending student credentials and onboarding messages upon account creation.
